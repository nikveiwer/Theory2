    ...
    return (
        <form className="form" onSubmit={formik.handleSubmit}>
            ...
            <input
                ...
                onBlur={formik.handleBlur}
            />
            {formik.errors.amount && formik.touched.amount ? <div style={{"color": "red"}}>{formik.errors.name}</div> : null}
            ...
            {formik.errors.currency && formik.touched.currency ? <div style={{"color": "red"}}>{formik.errors.name}</div> : null}
